...
Summary: This notebook contains code 
...
ggplot(aes(x = age_at_last_app, y = no_race_change, group = category, color = category))+ 
  geom_line(size = 1.5) +
  ...
  scale_color_viridis_d(guide = FALSE, end = 1)

ggsave(plot = change_by_age, filename = here("illustrations/race_change_by_age.png"), height = 10, width = 12)
```
